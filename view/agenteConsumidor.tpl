...
<ul>
	...
	<li>Programa de fidelização Com o Cartão de Pontos MoneyOne, seus clientes poupam tempo e recebem pontos por cada transacção realizada. <a href="cartaoPontos.php" class="content_link">Descubra mais sobre o programa.</a>
	</li>
</ul>
{/block}
