                        ...
                        <td class="content_texto">
                            ...
                            <p><br/></p>
                             <ul class="content_lista">
                                ...
                                <li><a href="agenteConsumidore.php"  class="content_link"><strong>Benefícios para os consumidores</strong></a></li><p><br/></p>
                            ...
                            <p><br/></p>
                            <p><br/></p>
                            <span class="content_title">Benefícios para os consumidores
                            </span><p><br/></p>
                            <span>Ao tornar-se um agente MoneyOne, você poderá oferecer os seguintes benefícios aos seus clientes:
                            </span><p><br/></p>
                            <ul class="content_lista">
                                <li><strong>Transferências de fundos rápidas, confiáveis e sem taxas de envio.</strong> <br/><br/></li>
                                <li><strong>Uma rede abrangente</strong><br/> Com o serviço MoneyOne seus clientes poderão enviar fundos para mais de 100 países  em todo o mundo.<br/><br/></li>
                                <li><strong>Programa de fidelização</strong><br/> Com o Cartão de Pontos MoneyOne, seus clientes poupam tempo e recebem pontos por cada transacção realizada. <a href="cartaoPontos.php"  class="content_link">Descubra mais sobre o programa.</a><br/><br/></li>
                            </ul>
