<div class='texto'>
	...
	<br />
	<div>Contatos:</div>
	<div>Telefone:<input type='text' name='telefone' value='{$user->telefone}'/></div>
	<div>Telemóvel:<input type='text' name='telemovel' value='{$user->telemovel}'/></div>
	<div>Email:<input type='text' name='email' value='{$user->email}'/></div>
	<br />
		Pretende receber newsletter?
		{if $user->CliMailing eq 1}
