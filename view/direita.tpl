<div class="content_conteudo_division">
	<div class='cartaz'>
		<script type="text/javascript">
                    ...
                    pausecontent[5]='<a href="promocao9.php" alt="blank" title="Saber mais" style="width: 100%;max-width: 100%;min-width: 100%;"><img style="width: 100%;max-width: 100%;min-width: 100%;" src="imagens/inicio/cartaz_small.jpg" alt="imagem"/></a>'
