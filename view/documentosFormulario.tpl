<div class='texto'>
		Actividade:<input type='text' name='actividade' value='{$user->actividade}'/>
	<br />
		Conhecimento:
	...
	<br />
		Mês/Ano de referências:<input type='text' value=''  name='referenciaVencimento'/>
	<br />
		Documentos:
		Tipo:
		{*O tipo é necessário ir preenchido *}
	<select class='combobox' name='tipo'>
		...
		<option value='tituloDeResidencia'>Titulo de Residencia</option>
	...
	{*<div>Documento a ser enviado:<input name='uploaded_file' type='file'/></div>*}
</div>
