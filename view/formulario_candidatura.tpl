<form name="candidatura" action="emprego.php" method='post'>
    <fieldset style="width: 850px;">
        ...
        <div class='left'>Nome Completo:</div><div class='right'><input name="nome" type="text" size="87" value="nome" />*</div>
        <div class='left'>Nacionalidade:</div><div class='right'><input name="nacionalidade" type="text" size="25" value="Portuguesa" />*</div>
        <div class='left'>N.º Doc. Identificação:</div><div class='right'><input name="identifDoc" type="text" size="25" value="12345678" />* <input type="radio" name="tipoDoc" id="radio" value="Passaporte" /> Passaporte <input type="radio" name="tipoDoc" id="radio" value="C. Cidadao" /> C. Cidadão <input type="radio" name="tipoDoc" id="radio" value="B. Identidade" checked='checked' /> B.Ident. <input type="radio" name="tipoDoc" id="radio" value="A.Residência" /> A.Residência*</div>
        ...
        <div class='left'>Morada:</div><div class='right'><input name="morada" type="text" size="87" value="Rua..." />*</div>
        <div class='left'>Código Postal:</div><div class='right'><input name="codPostal1" type="text" maxlength="4" size="6" value="1900" />- <input name="codPostal2" type="text" maxlength="3" size="4" value="123" />* Localidade: <input name="localidade" type="text" size="30" value="Lisboa" />*</div>
        <div class='left'>Telefone:</div><div class='right'><input name="telefone" type="text" size="20" maxlength="9" value="961213456" />* Email: <input name="email" type="text" size="46" value="email@mail.com" />*</div>
        <div class='left'>N.º Carta de Condução:</div><div class='right'><input name="cartaConducao" type="text" size="9" value="123456789" /></div>
        ...
        <div class='left'>Experiência profissional?</div><div class='right'><textarea name="experienciaProfissional" cols="55" rows="5">Experiência</textarea></div>
        <div class='left'>Empresas onde trabalhou?</div><div class='right'><textarea name="empresaTrabalhou" cols="55" rows="5">Empresa</textarea></div>
        <div class='left'>Motivo pelo qual gostaria de trabalhar na MoneyOne?</div><div class='right'><textarea name="motivoMoney" cols="55" rows="5">Motivo</textarea></div>
        <div class='left'>Como reagiria se um/a cliente o/a acusasse de não ter feito um pedido como solicitado?</div><div class='right'><textarea name="pedidoSolicitado" cols="55" rows="5">Tentaria resolver com calma</textarea></div>
