...
<div class='texto'>
    ...
    <div class='clear'>&nbsp;</div>
    1 - O cliente realiza transferência ou depósito (nesse caso, deve ser informado no ato do depósito o nome do depositante) para qualquer uma das nossas contas listadas abaixo.
    <div class='clear'>&nbsp;</div>
